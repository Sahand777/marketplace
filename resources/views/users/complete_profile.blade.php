...
@section('page-content')
        ...
        <!--                                <div class="col-sm-6 registrationFormFieldCont">
                                        ...
                                        <div class="col-sm-6 registrationFormFieldCont">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input-lg" value="{{old('mobile_number')}}" name="mobile_number" aria-describedby="basic-addon1">
                                            </div>
                                        </div>
                                        <div class="col-sm-6 registrationFormFieldCont">
                                            <label>I have sales/purchase approval authority *</label><br/>
                                            <span class="radioBtnCont">
                                                <input type="radio" required name="approvalPower" onclick="showHideField(this, '2', '#approvalEmail', '')" 
                                                       @if (old('approvalPower') == 1) checked  @endif value="1" id="approvalPowerVal1"/>
                                                <label for="approvalPowerVal1">Yes</label>
                                            </span>
                                            <span class="radioBtnCont">
                                                <input type="radio" name="approvalPower" onclick="showHideField(this, '2', '#approvalEmail', '')" 
                                                       @if (old('approvalPower') == 2) checked  @endif value="2" id="approvalPowerVal2"/>
                                                <label for="approvalPowerVal2">No</label>
                                            </span>
                                        </div>
                                        <div class="col-sm-6 registrationFormFieldCont">
                                            <label>Enter a different email for sales/purchase approval</label> &nbsp;
                                            <a data-toggle="tooltip" title="This is email address of an individual in your organization with sales/purchase approval power">
                                                <i class="glyphicon glyphicon-info-sign"></i></a>
                                            <div class="input-group">
                                                <span class="input-group-addon input-lg" id="basic-addon1">
                                                    <img src="{{ asset('img/front/form_icon_email.png') }}" alt="" /></span>
                                                <input type="email" class="form-control input-lg" value="{{old('approval_email')}}" name="approval_email" 
                                                       id="approvalEmail" aria-describedby="basic-addon1">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12 registrationFormFieldCont text-right">
                                            <label> </label>
                                            <input id="section-1-right" type="button" class="btn btnWithRightArrow" value="CONTINUE" />
                                        </div>
                                    </div>
                                </div>
                                <div class="personalInner addInner animated" id="section-2">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 registrationFormFieldCont">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input-lg" value="{{old('website')}}" name="website" required 
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 registrationFormFieldCont">
                                            <label> </label>
                                            <input id="section-2-left" type="button" class="btn blackBtn" value="BACK"/>
                                        </div>
                                        <div class="col-sm-6 registrationFormFieldCont text-right">
                                            <label> </label>
                                            <input id="section-2-right" type="button" class="btn blackBtn btnWithRightArrow" value="CONTINUE"/>
                                            
                                            <input type="submit" class="btn blackBtn btnWithRightArrow" value="SUBMIT NOW"/>
                                        </div>
                                    </div>
                                </div>
    ...
    <!--                                    <div class="col-sm-6 registrationFormFieldCont">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 registrationFormFieldCont">
                                            <label> </label>
                                            <input id="section-3-left" type="button" class="btn blackBtn" value="BACK" />
                                        </div>
                                        <div class="col-sm-6 registrationFormFieldCont text-right">
                                            <label> </label>
                                            <input type="submit" class="btn blackBtn btnWithRightArrow" value="SUBMIT NOW"/>
