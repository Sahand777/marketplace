    ...
    <body>
        ...
        <div style="max-width: 800px; padding-right: 15px;padding-left: 15px;margin-right: auto;margin-left: auto;">
            <div style="margin-right: 50px;">
                <a href="/"><img src="{{asset('img/front/inner_logo.gif')}}" alt="Firmogram" style="width:27%; padding: 10px"></a>
              
            </div>
            <div>
                <img src="{{asset('img/notification_image/2016/9/06/'.$imgname->template_image)}}" alt="Firmogram" style="width: 100%">
            </div>
