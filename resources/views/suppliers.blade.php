                ...
                <div class="row">
                    <div class="col-xs-12 text-justify">
                        ...
                        <p>Reaching greater numbers of potential customers is one of the highest priorities of companies that provide business services. 
                            ...
                            type of customers.</p>
                        <p>FIRMOGRAM marketplace allows service providers to maximize their selling potential by creating direct connections between 
                                ...
                                <div class="smallBubble">
                                    <div class="divTable">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <p>The FIRMOGRAM marketplace brings real leads to the table that are actively looking to purchase services.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="smallBubble">
                                    <div class="divTable">
                                        ...
                                        <div class="col-md-9">
                                            <h3>Your Criteria</h3>
                                            <p>Once you register your company on FIRMOGRAM and indicate your preferences, you will get linked with the 
                            ...
                            <div class="col-md-4">
                                <div class="smallBubble">
                                    <div class="divTable">
                                        ...
                                        <div class="col-md-9">
                                            <h3>Get Notified</h3>
                                            <p>No need to constantly check your FIRMOGRAM dashboard for updates on customers. You’ll receive email 
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 text-justify">
                        ...
                        <p>FIRMOGRAM consolidates large amounts of business ecosystem data and, more importantly, helps you make sense of it. Where does 
                            your company fit, who should you be watching out for, and where are your ideal customers?  When you can answers these 
                            questions, you can develop a more focused strategy and brand - and use FIRMOGRAM to help get the word out.</p><br/><br/>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="smallBubble">
                                    <div class="divTable">
                            ...
                            <div class="col-md-4">
                                <div class="smallBubble">
                                    <div class="divTable">
                                        ...
                                        <div class="col-md-9">
                                            <p>Use FIRMOGRAM marketplace to advertise your company to the most interested customers</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
