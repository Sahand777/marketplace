                            ...
                            <span>
                                <form action="{{url('search-form-submission')}}" id="homeSearchForm" method="POST">
                                    ...
                                    <input type="text" class="firms" id="autocomplete-ajax" name="searchKeyword" 
                                           placeholder="Search for Firms, Services, Products, Industry, City"/>
                                    <input type="submit" class="submit" value="GET STARTED"/>
                                    <a href="{{url()}}/#howItWorks" class="linkToHowItWorks btn tranparentWhiteBtn">Learn More</a>
                                </form>
                            </span>
                        </div>
                    </div>
        ...
        <section class="categoriesWithImgSection">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <h1>CATEGORIES</h1>
                        <p>Firms in nearly all industrial sectors need better and faster ways to procure products and 
                            professional services. FIRMOGRAM can be used to connect in numerous industries because the plaform is flexible and the 
                            ...
                            FIRMOGRAM's matchmaking and transactional capabilities because they involve high numbers of active businesses services.</p>
                                        ...
                                        <div class="col-sm-4">
                                            <a class="categoryWithImg" href="{{ url('/categories/'.$category->slug) }}" data-toggle="tooltip"
                                               title="{{$tooltip}}" data-html="true">
                                                ...
                                                <img src="{{asset('img')}}/{{(empty($category->image))?"front/placeholder_main_cat.jpg":"category/".$category->image}}" 
                                                     alt="{{$category->name}}" />
                                            </a>
                                        </div>
                                    @endforeach
...
<!--                        <p class="text-center">Businesses in nearly all industrial sectors need better and faster ways to procure products and 
                            professional services. FIRMOGRAM can be used to connect in numerous industries because the plaMorm is flexible and the 
                            database of registered service providers is large and expanding. The industries listed below are particularly well suited for 
                            FIRMOGRAM's matchmaking and transactional capabilities because they involve high numbers of active businesses services.</p>-->
