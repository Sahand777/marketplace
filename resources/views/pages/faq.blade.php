    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 terms_conditions">
                ...
                <p>You wouldn't need to ! FIRMOGRAM's marketplace runs throughout Canada and the United States, so the only major change you need to make is your location on your account information. However, if you're planning on moving internationally or to an area where our networks cannot reach you, all you need is to <a href="{{url('contact-us')}}">contact us</a> and let us know your plans.</p>
                ...
                <p>For companies that provide services, our pricing system depends on how much traffic you want for your business. It solely depends on how much of our marketing and analytics potential you want from FIRMOGRAM. We can provide you variety of services, anywhere between a free page where people can see and read about your business, to keeping in close contact with you to ensure that you know exactly what your business is doing, who your business is talking to, and how it is doing in comparison to your competitive business environment. If you're curious, <a href="{{url('contact-us')}}">contact us</a> and we will have a FIRMOGRAM representative provide you with a more in depth description of how we can help your business grow. </p>
                <p>How it works 
                    If you're looking for services in your local area, FIRMOGRAM is a good place to start. With FIRMOGRAM, you can apply to be free member From the backend, you can collect your list of local service providers, including those that are not registered in our database.  You can also communicate with the providers directly via your dashboard that is customizable. Keep track of all of your contacts, ratings, messages, and easily organize your quotes in one place. 
                    If you're a service provider looking to gain much better traffic for your business, FIRMOGRAM can do that for you! As well, you can rest easy knowing that your business is sitting amongst other carefully vetted services, so potential customers visiting our marketplace will feel safe and free to read about your business and select it for quotes. 
                </p>
                <h3>Why should I use it ?</h3>
                <p>On top of the steady amount of traffic coming through the FIRMOGRAM Marketplace, customer services representatives at FIRMOGRAM will always available for you to contact and ask for marketing and analytics help <a href="{{url('contact-us')}}">contact us</a>. We know that it could be a handful and also expensive to come up with a unique marketing plan for your business. With FIRMOGRAM, you get the best of both worlds: healthy traffic for your business that you can control, and reliable customer service that meets your standards.</p>
                <h3>How do I get an account ?</h3>
                <p>There's an orange TRY IT FREE button at the top right of your screen! Just click that, and a form will appear for you to fill out as step 1 of your profile. We will have a FIRMOGRAM customer representative send you a confirmation email shortly. Once you get into the dashboard, you may start customizing the content only available to you! If you need any help with filling out your profile, just email us at <a href="mailto:info@firmogram.com">info@firmogram.com</a> or give us a call at <a href="Tel:+1 855 782 6882">+1 855 782 6882</a></p>
            </div>
        </div>
    </div>
</section>
