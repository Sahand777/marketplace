            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 terms_conditions">
                        <h1>ABOUT</h1>
                        <p>FIRMOGRAM is a unique online marketplace for professional service providers to interact directly with motivated local and national business customers. It utilizes business data analytics and visualizations to enhance the entire procurement process, from initial communications to final payment. The platform is presently targeted for services within clean-tech sector, looking to cut energy costs by considering the greener alternatives.</p>
<!--                         <img src="{{asset('img/about_image1.png ')}}" alt="Fimogram_platform"    />-->
                         <!--<h2>FIRMOGRAM simplifies the steps of service and trades procurement for businesses. It is a cloud-based platform that empowers businesses to create, manage and pay their external workforce, all from one dashboard</h2>-->
                         ...
                         <p>Focusing on <span style="font-weight:bold">consulting engineering services within clean-tech vertical,</span> FIRMOGRAM eliminates the complexity of service procurement, thereby increasing revenues for service providers by directly connecting them to real leads and removing workflow hurdles.</p>
