...
<html prefix="og: http://ogp.me/ns#">
    ...
    <body>
        ...
        <section class="homeHeaderSection frontpage_section">
                ...
                <div class="container">
                    <div class="row menuAndLogoCont">
                        <div class="banner-text homeTopBannerText">
                            ...
                            <h4 class="text-center">All in one dashboard</h4>
            ...
            <div class="bannerServicSuppliersLinkCont homeBannerSupplierLink text-center hidden-sm hidden-xs">
                        ...
                        <div class="col-md-12">
                            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                ...
                                <ol class="carousel-indicators">
                                    <li dateta-target="#myCarousel" data-slide-to="0" class="active"></li>
                                ...
                                <div class="carousel-inner" role="listbox">
                                    <div class="item active">
                                        <div class="banner-text homeTopBannerText">
                                            ...
                                            <p class="text-center">All in one dashboard</p> 
                                            <span class="text-center">
                                                <input type="submit" class="submit" onclick="window.location.href='{{url('request-service/1')}}'" 
                                                       value="REQUEST A SERVICE"/>
                                                <a href="{{url('suppliers')}}" class="linkToHowItWorks btn tranparentWhiteBtn hidden-sm hidden-xs">Provide A Service</a>
                                    ...
                                    <div class="item">
                                        <div class="banner-text homeTopBannerText">
                                            <p class="text-center">The Marketplace For Condo Services</p>
                                            <p class="text-center">Streamline your workflow</p> 
                                            <span class="text-center">
                                                <input type="submit" class="submit" onclick="window.location.href='{{url('request-service/1')}}'" 
                                                       value="REQUEST A SERVICE"/>
                                                <a href="{{url('suppliers')}}" class="linkToHowItWorks btn tranparentWhiteBtn hidden-sm hidden-xs">Provide A Service</a>
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="item active">
                                    <div class="testimonials-text">
                                        <p>"As an engineering consulting firm, we used firmogram’s marketplace analytics platform to  identify our target customers and our competitors. The best part was that we could directly  connect and respond to any prospect customers, all from one platform!"</p>
                                        <p><span>----</span> M.B., Engineering Consultant</p>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="testimonials-text">
                                        <p>"We continuously procure high quality local professionals for our day to day operations. Using Firmogram marketplace and its high quality business data analytics, we were able to find and quickly connect to the right local professionals."</p>
                                        <p><span>----</span> Auto OEM Company</p>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="testimonials-text">
                                        <p>"I loved using Firmogram! It was so easy to find the right contractors  for the renovation project and other day to day maintenance work in our condo. The service providers are all hand picked and are carefully vetted. We also added our list of trades and organized our workflow!"</p>
                                        <p><span>----</span> On-Site Strata Manager</p>
                                    </div>
                                </div>
                            </div>
