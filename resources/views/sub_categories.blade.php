            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <p class="text-center">These additional @if ($categoryDetails) {{$categoryDetails->name}} @endif  service categories are not as 
                            heavily represented by suppliers as those categories shown above, but they do involve numerous firms that show high levels 
                            of interest in attaining new customers using FIRMOGRAM.</p>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <p class="text-center">The leading providers of @if ($categoryDetails) {{$categoryDetails->name}} @endif services are shown below. 
                            Use FIRMOGRAM to connect with these businesses and receive free quotes, instantly!</p>
