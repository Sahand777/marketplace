@extends('templates.sub_pages_template_2')
                ...
                <div class="col-sm-12">
                    <div class="userTypeCont">
                        <span class="radioBtnCont">
                            <input  type="radio" required name="iAmA" value="1" id="iAmAVal1" @if (old('iAmA') == 1) checked  @endif 
                                    onclick="signupShowHideBuyerSupplierFields(this)" />
                                    <label for="iAmAVal1">Buyer</label>
                        </span>
                        <span class="radioBtnCont">
                            <input type="radio" name="iAmA" value="2" id="iAmAVal2" @if (old('iAmA') == 2) checked  @endif 
                                   onclick="signupShowHideBuyerSupplierFields(this)" />
                                   <label for="iAmAVal2">Supplier</label>
                        </span>
                        <span class="radioBtnCont both-sign-up">
                            <input type="radio" name="iAmA" value="3" id="iAmAVal3" @if (old('iAmA') == 3) checked  @endif 
                                   onclick="signupShowHideBuyerSupplierFields(this)" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group login-field">
                                    ...
                                    <input required id = "first_name_register" type="text" name="first_name" class="form-control" value="{{old('first_name')}}" 
                            ...
                            <div class="col-sm-6">
                                <div class="input-group login-field">
                                    <span><img src="{{ asset('img/front/login-profile-img.png') }}"></span>
                                    <input required id="first_last_register" type="text" name="last_name" class="form-control" value="{{old('last_name')}}" 
                            ...
                            <div class="col-sm-12">
                                <div class="input-group login-field">
                                    ...
                                    <input type="text" id="getCompany-ajax" required name="business_name" class="form-control" value="{{old('business_name')}}" 
                            ...
                            <div class="col-sm-12">
                                <div class="input-group login-field">
                                    ...
                                    <input required id="email_register" type="email" name="email" class="form-control" value="{{old('email')}}" 
                            ...
                            <div class="col-sm-12 registrationFormFieldCont sectionThreeTermsAndConditions">
                                <span class="checkboxCont margin-top-15">
                                    <label for="termsAndConditions"><p>By clicking "Join FIRMOGRAM", I acknowledge and agree to the 
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="text-center submit-btn-auth">
                                        <input type="submit" class="" value="Join FIRMOGRAM">
                                    </div>
                                </div>
        ...
        <div class="col-sm-12 otherLogins register text-center">
            <div class="col-sm-12 social_login_div">
                ...
                <span class="radioBtnCont">
                    ...
                    <label for="iAmA2Val1">Buyer</label>
                </span>
                <span class="radioBtnCont sign-up-supplier-social">
                    <input type="radio" name="iAmA2" value="2" id="iAmA2Val2" />
                    <label for="iAmA2Val2">Supplier</label>
                </span>
                <span class="radioBtnCont">
                    <input type="radio" name="iAmA2" value="3" id="iAmA2Val3" />
                    <label for="iAmA2Val3">Both</label>
                </span>
            </div>
