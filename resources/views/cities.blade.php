    ...
    <body>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <p class="text-center">The primary services being offered in @if ($cityDetails) {{$cityDetails['name']}} @endif are shown below. 
                            These services are offered by multiple suppliers, each of which are active and are looking to provide these services to new 
                            customers.</p>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <p class="text-center">Other services being offered in @if ($cityDetails) {{$cityDetails['name']}} @endif are shown below. These 
                            are services that are being offered by at least one supplier in @if ($cityDetails) {{$cityDetails['name']}} @endif.</p>
        ...
        <section class="categoriesWithImgSection">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="text-center"><a href="{{url('suppliers-list')}}" class="text-center btn">Suppliers Directory</a></div>
                        <h1 class="text-uppercase">SERVICE SUPPLIERS IN @if ($cityDetails) {{$cityDetails['name']}} @endif</h1>
                        <p class="text-center">The leading firms in @if ($cityDetails) {{$cityDetails['name']}} @endif are shown below. Detailed 
                            Information and data for these companies can be viewed in Suppliers Directory.</p>
