                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="newletterCont">
                                ...
                                <p>Create competitive advantage with FIRMOGRAM by procuring from quality local services!</p>
                                <p><a class="btn btnWithRightArrow" href="{{url('contact-us')}}">REQUEST A DEMO</a></p>
                            </div>
                        </div>
                    </div>
                </div>
