        <meta property="og:image" content="http://www.firmogram.com/img/front/logo2.png" />
        <meta property="og:image:secure_url" content="https://www.firmogram.com/img/front/logo2.png" /> 
        ...
        <!--<meta property="og:image" content="{{ asset('/img/front/inner_logo.png') }}" />-->
        <!--        ----------------------------Style Sheets-------------------------- -->
