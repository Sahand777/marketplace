                            ...
                            <div class="dashboardSidebarMenuCont">
                                <ul class="dashboardSidebarMenu">
                                    @if ($userType == 1)
                                        ...
                                        <li class="{{activeMenu('mySupplier')}}"><a href="{{url('supplier-buyer-list')}}" class="dashboardLinkMyProfile">My Supplier list</a></li>
                                        
                                        <li class="{{activeMenu('Import-Supplier-List')}} profile-submenue"><a href="{{url('importSupplier')}}" class="subm">Import Supplier List</a></li>
                                             <li class="{{activeMenu('Add-Supplier')}} profile-submenue"><a href="{{url('mysupplier-add')}}" class="subm">Add Supplier</a></li>
                                             <li class="{{activeMenu('Add-Supplier-from-database')}} profile-submenue"><a href="{{url('allsupplier')}}" class="subm">Add Supplier from database</a></li>
