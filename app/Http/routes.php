...
Route::post('sociallogin', 'SocialController@sociallogin');
 Route::get('wp', 'AjaxRequests@AutoComplete');
...
Route::post('ajax/autocomplete', 'AjaxRequests@AutoComplete');
Route::post('ajax/get-sub-categories', 'AjaxRequests@GetSubCategories');
Route::get('ajax/newsletter', 'AjaxRequests@NewsLetter');
...
Route::get('search-form-submission-home', 'Process@SearchFormSubmision');
